...
```bash
git remote add encore encore://u3bl-sports-league-website-ift2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/u3bl-sports-league-website-ift2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/u3bl-sports-league-website-ift2/settings/integrations/github)
